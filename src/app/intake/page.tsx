...
${formData.additionalNotes || 'None'}
    ...
    if (submitted) {
        return (
            <div className="min-h-screen bg-gradient-to-br from-[#ff9433] to-[#ff7a1a] flex items-center justify-center p-6">
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#ff9433] to-[#ff7a1a]">
            {/* Header */}
